...
exports.validatePlaywrightArtifacts = validatePlaywrightArtifacts;

function diagnostic(code, message, severity, path, details = {}) {
...
function validateCommon(artifact) {
  const diagnostics = [];
...
function validatePageObject(artifact) {
  const diagnostics = [];
...
function validatePlaywrightArtifacts(request) {
  const diagnostics = [];
